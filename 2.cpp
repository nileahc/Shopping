...
//
//    }
//    Outer(int number, string name, int price, string brand, string outer_Type, string outer_Down, string outer_Length, string outer_Size) 
//        : Clothes(number, name, price, brand), outer_Type(outer_Type), outer_Down(outer_Down), outer_Length(outer_Length), outer_Size(outer_Size)
//    {
//
//    }
...
//
//    }
//    Top(int number, string name, int price, string brand, string top_Type, string top_Length, string top_Size) 
//        : Clothes(number, name, price, brand), top_Type(top_Type), top_Length(top_Length), top_Size(top_Size)
//    {
//
//    }
//
...
//
//    }
//    Pants(int number, string name, int price, string brand, string pants_Shape, string pants_Size, string pants_Length) 
//        : Clothes(number, name, price, brand), pants_Shape(pants_Shape), pants_Size(pants_Size), pants_Length(pants_Length)
//    {
//
//    }
...
//public:
//    Shoes() {}
//    Shoes(int number, string name, int price, string brand, string shoes_Type, int shoes_Size, int shoes_Heel) 
//        :Clothes(number, name, price, brand), shoes_Type(shoes_Type), shoes_Size(shoes_Size), shoes_Heel(shoes_Heel)
//    {
//
//    }
//
...
//
//                    Basket b2;
//                    b2.name = vt.at(i).name;   // 장바구니에 이름 넣기  
...
//
//                    Basket b3;
//                    b3.name = vp.at(i).name;   // 장바구니에 이름 넣기 
...
//
//                    Basket b4;
//                    b4.name = vs.at(i).name;   // 장바구니에 이름 넣기  
